# 模型机器---R语言tidymodels包机器学习分类与回归模型---多分类---单隐藏层神经网络
...
# 超参数寻优范围
hpset_mlp <- parameters(hidden_units(range = c(8, 15)),
                    penalty(range = c(-3, 0)),
...
force_plot(object = shap[1L, ], 
           ...
           baseline = mean(predtrain_mlp$.pred_H),
           display = "viewer") 
